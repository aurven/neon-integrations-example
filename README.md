...
mkcert neon-integrations-example.neon.com localhost 127.0.0.1 ::1

# Move certificates to ssl directory
mkdir -p ssl
mv neon-integrations-example.neon.com+3.pem ssl/
mv neon-integrations-example.neon.com+3-key.pem ssl/
```
...
# Add this line:
127.0.0.1 neon-integrations-example.neon.com
```
...
```bash
PORT=54861
PROJECT_DOMAIN=https://neon-integrations-example.neon.com:54861
```
...
- 🔒 **HTTPS Custom Domain**: https://neon-integrations-example.neon.com:54861
...
rm ssl/neon-integrations-example.neon.com+3*

# Generate new certificates
mkcert neon-integrations-example.neon.com localhost 127.0.0.1 ::1
mv neon-integrations-example.neon.com+3* ssl/
```
...
mkcert neon-integrations-example.neon.com another-domain.dev localhost 127.0.0.1 ::1
